...
class Q_ADDON_PROCESSMANAGER_EXPORT QDeclarativeRewriteDelegate : public QRewriteDelegate,
...
public:
    QDeclarativeRewriteDelegate(QObject *parent=0);
...
QML_DECLARE_TYPE(QT_PREPEND_NAMESPACE_PROCESSMANAGER(QDeclarativeRewriteDelegate))
